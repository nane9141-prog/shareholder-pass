...
window.PASS_CO = [
  { key: 'kakaobank', nm: '카카오뱅크', term: '제10기 정기주주총회', status: 'live',
    ...
    mine: true, kind: '보통주', shares: '1,200주', dday: 'D-14' },
  ...
  { key: 'hyundai', nm: '현대', term: '제9기 정기주주총회', status: 'dday',
    ...
    mine: true, kind: '보통주', shares: '340주', dday: 'D-day' },
  ...
  { key: 'shinsegae', nm: '신세계', term: '제9기 정기주주총회', status: 'end',
    ...
    mine: true, kind: '보통주', shares: '260주' },

  { key: 'kia', nm: '기아', term: '제9기 정기주주총회', status: 'end',
    date: '2026년 3월 12일 (목)', time: '오전 9:00',
    place: '서울 서초구 기아 본사 대강당',
    hero: ['#6b6b6b', '#111'], ink: '#fff',
    mine: true, kind: '보통주', shares: '1,050주' },

  { key: 'korea-zinc', nm: '고려아연', term: '제9기 정기주주총회', status: 'dn', d: 'D-12',
    date: '2026년 3월 31일 (화)', time: '오전 10:00',
    place: '서울 강남구 본사 대회의실',
    hero: ['#5fbf9b', '#0f7d57'], ink: '#fff',
    mine: true, kind: '보통주', shares: '85주', dday: 'D-12' },
